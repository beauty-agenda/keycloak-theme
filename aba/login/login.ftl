                ...
                <#if realm.password>
                    <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}"
                        ...
                        <div class="${properties.kcFormGroupClass!}">
                            ...
                            <#else>
                                <input tabindex="1" id="username" class="${properties.kcInputClass!}" name="username"
                                       value="${(login.username!'')}" type="text" autofocus required
                                       autocomplete="off"/>
                            </#if>
                            <label for="username"
                        ...
                        <div class="${properties.abaSignUpIndicatorWrapperClass!}">
                            <p>${msg("doNotHaveAccountYet")} <a href="${properties.baseDomain!}/signup"
                                                                class="${properties.kcSignUpLinkClass!}">${msg("createAccount")}</a>
                            </p>
                        </div>
                    </form>
                </#if>
